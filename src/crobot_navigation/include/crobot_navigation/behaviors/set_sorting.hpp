...
class SetSorting : public BT::SyncActionNode
{
public:
SetSorting(const std::string &name, const BT::NodeConfig& config, rclcpp::Node::SharedPtr node_ptr);

  static BT::PortsList providedPorts()
  {
    return { BT::InputPort<std::string>("setSorting")};
  }
